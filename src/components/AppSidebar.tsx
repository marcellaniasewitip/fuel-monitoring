...
export function AppSidebar() {
  ...
  return (
    <Sidebar collapsible="icon">
        ...
        <div className="flex items-center gap-3">
          ...
          {!collapsed && (
            <div className="animate-slide-in">
              ...
              <p className="text-[10px] font-mono text-sidebar-foreground uppercase tracking-widest">
                Monitor
              </p>
            </div>
          )}
      ...
      <SidebarContent>
        <SidebarGroup>
          <SidebarGroupLabel className="text-[10px] uppercase tracking-widest font-mono">
            Operations
          </SidebarGroupLabel>
          <SidebarGroupContent>
            <SidebarMenu>
